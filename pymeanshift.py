...
def segment(image, spatial_radius, range_radius, min_density, skernel="Uniform", rkernel="Uniform", speedup_level=SPEEDUP_HIGH):
    '''
    ...
    '''
    return _pymeanshift.segment(image, spatial_radius, range_radius, min_density, skernel, rkernel, speedup_level)
...
class Segmenter(object):
    ...
    def __init__(self, spatial_radius=None, range_radius=None, min_density=None, skernel="Uniform", rkernel="Uniform", speedup_level=SPEEDUP_HIGH):
        '''
    ...
    def __call__(self, image):
        ...
        return _pymeanshift.segment(image, self._spatial_radius, self._range_radius, self._min_density, self.skernel, self.rkernel, self._speedup_level)
    ...
    @skernel.setter
    def skernel(self, value):
        if value != "Uniform" and value != "Gaussian":
            raise AttributeError("Bad Kernel chosen")
        self.skernel = value
